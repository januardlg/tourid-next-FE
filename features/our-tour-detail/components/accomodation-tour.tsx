    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-2 gap-10">
                ...
                <div>
                    <p className="text-lg">Horas Hotel</p>
                    <a className="text-blue-600" rel="noopener noreferrer" href={'https://google.com/maps/place/hotel+indonesia/data=!4m2!3m1!1s0x2e69f421963cd607:0x503cb9e9306e657a?sa=X&ved=1t:242&ictx=111'} target="_blank">View On Map</a>
                </div>
            </div>
        </section>
    )
}
export default AccomodationTour
